# Домашнее задание №2 к лекции «Обработка событий»

[![Build status](https://ci.appveyor.com/api/projects/status/vnk7s0ysw83eb17n?svg=true)](https://ci.appveyor.com/project/yuriyvyatkin/ahj-hw-3-2-top-tasks)
